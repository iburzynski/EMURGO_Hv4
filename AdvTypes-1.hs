...
-- nt' = nameTuple' ln' fn' << this will not!
...
-- is also called "constrained polymorphism" sometimes for this reason.
...
-- One parameter: * -> *
-- Two parameters: * -> * -> *
-- Type `:kind` or `:k` in GHCi followed by a Type to see its kind signature
